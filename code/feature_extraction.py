...
def extract_graph_node_features(G, df_graph, G_indirect, df_indirect_graph, G_indirect_all,
    ...
    if 'dataflow' in selected_features:
        dataflow_features, dataflow_feature_names = fs.get_dataflow_features(G, df_graph, node, dict_redirect, G_indirect, G_indirect_all, df_indirect_graph)
...
def extract_graph_features(df_graph, G, vid, ldb, feature_config):
    ...
    if 'dataflow' in selected_features:
        dict_redirect, G_indirect, G_indirect_all, df_indirect_graph = fs.pre_extraction(G, df_graph)
