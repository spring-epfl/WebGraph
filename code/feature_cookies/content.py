...
def get_url_features(url, node_dict):
    ...
    keyword_char = [".", "/", "&", "=", ";", "-", "_", "/", "*", "^", "?", ";", "|", ","]
    screen_resolution = [
        "screenheight", "screenwidth", "browserheight", "browserwidth", "screendensity",
        "screen_res", "screen_param", "screenresolution", "browsertimeoffset"
    ]
    ...
    url_features = [
        is_valid_qs, num_url_queries, num_url_params, num_id_in_query_field,
    ...
    url_feature_names = [
        'is_third_party', 'base_domain_in_query',
        'semicolon_in_query', 'semicolon_in_params', 'screen_size_present',
        'ad_size_present', 'ad_size_in_qs_present', 'keyword_raw_present',
        'keyword_char_present'
    ]
