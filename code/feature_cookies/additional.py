...
def get_structure_additional(G, df_graph, node):
    ...
    try:
        ...
        sa_features = [
            num_cs_edges_sent, num_cs_edges_rec, num_diff_domain_predecessors,
...
def get_response_features(df_graph, node):
    ...
    response_features = [
        max_rec_response_length, min_rec_response_length,
...
def get_cookie_features(G, df_graph, node):
    ...
    cookie_features = [
        max_size_name, max_size_val, min_size_name, min_size_val, mean_size_name,
        mean_size_val, num_httponly, num_diff_domain
    ]
    cookie_feature_names = [
        'max_size_name', 'max_size_val', 'min_size_name', 'min_size_val',
